...
Generate complete JSON with ${template.beatCount} shots.`;
    ...
    // _convertToStoryPlan already puts all shots into segments[0].shots correctly.
    // The filter was incorrectly matching act names (e.g. '起/Setup') against segment IDs (e.g. 'act1').
    // No redistribution needed — skip this step.
    return storyPlan;
  }
