...
index_optimization:
  weighted_recall_text: 产品增长 用户增长 增长策略 获客策略 留存策略 增长黑客
  neighbors: []
  channel_weights:
    exact_match: 10
    lexical_variation: 8
...
generation_spec:
  title: 产品增长设计
  summary: 掌握产品增长策略和设计方法
  output_mode: blueprint
  skill_blueprint_id: product_growth
  skill_run_id: null
  skill_version: 1.0.0
  skill_type: operational_skill
  automation_level: L2
  risk_level: medium
  core_goal: 帮助产品经理制定增长策略
  non_goals: 不涉及具体投放策略
  success_metrics:
    - 用户增长率
    - 获客成本
...
增长核心：获客→激活→留存→变现→推荐，五步实现产品增长飞轮
...
| 阶段 | 说明 | 关键指标 |
|------|------|----------|
| Acquisition | 获取 | 获客成本/渠道ROI |
| Activation | 激活 | 首次使用/注册率 |
| Retention | 留存 | 留存率/活跃度 |
| Revenue | 变现 | 收入/ARPU |
| Referral | 推荐 | 裂变系数/推荐率 |
