...
index_optimization:
  weighted_recall_text: 迭代规划 版本规划 产品规划 Roadmap 迭代策略 版本管理
  neighbors: []
  channel_weights:
    exact_match: 10
    lexical_variation: 8
...
generation_spec:
  title: 产品迭代规划
  summary: 掌握产品迭代规划和版本管理方法
  output_mode: blueprint
  skill_blueprint_id: product_iteration
  skill_run_id: null
  skill_version: 1.0.0
  skill_type: method_skill
  automation_level: L2
  risk_level: low
  core_goal: 帮助产品经理规划产品迭代
