 ...
 *
 * 职责：
 * 1. 调用通用底层（documentary-director/）进行7维分析+合规检测+Prompt构建
...
const { CharacterAnalyzer } = require('../documentary-director/character-analyzer');
const { ComplianceGuard, COMPLIANCE_LEVELS } = require('../documentary-director/compliance-guard');
const { PromptArchitect } = require('../documentary-director/prompt-architect');
